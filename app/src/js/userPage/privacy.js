    ...
    return(
      <div className="about">
        ...
        <div className="content">
          ...
          <p>
            币比 PTE, LTD.（以下简称“本公司”或“我们”）尊重并保护用户（以下简称“您”或“用户”）的隐私，当您进行以下行为时，本公司按照本隐私政策（以下简称“本政策”）收集、披露和处理您的个人信息：
          </p>
          <p>
          ...
          <p>
            本公司建议您在使用应用之前仔细阅读并理解本政策全部内容, 针对免责声明等条款在内的重要信息将以加粗的形式体现。本政策有关关键词定义与本公司《币比服务协议》保持一致。如果本政策中使用的定义或术语与《币比服务协议》中的不一致，以本政策为准。&nbsp;
          </p>
          <p>
          ...
          <p>
            3.我们在币比的“系统设置”中为您提供“指纹登录”选项，让您方便且更安全地管理您的数字代币。 &nbsp;&nbsp;
          </p>
          <p>
          ...
          <p>
            5.我们的应用将包含链接，可链接至非由我们所有、运营、开发或维护的其他网站、应用或智能合约。这些链接系为您方便而提供。本政策仅适用于我们的应用。当您访问该等第三方网站或使用第三方应用或智能合约时，您知悉，我们的《币比服务协议》、《币比隐私政策》将不再适用。我们建议您详细阅读并了解其隐私规则和有关用户服务协议等内容。&nbsp;
          </p>
          <p>
          ...
          <p>
            3.我们将在币比“消息中心”中向您发送有关信息安全的消息，并不时在币比“帮助中心”版块更新钱包使用及信息保护的资料，供您参考。&nbsp;
          </p>
          <p>
          ...
          <p>
            2.我们建议未成年人的父母和监护人应当在阅读本政策、《币比服务协议》及我们的其他有关规则的前提下，指导未成年人使用应用。
          </p>
          <p>
