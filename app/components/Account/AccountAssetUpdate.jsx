...
class AccountAssetUpdate extends React.Component {
    ...
    _updateAsset(e) {
        ...
        AssetActions.updateAsset(issuer, new_issuer_account_id, update, core_exchange_rate, this.props.asset,
            flags, permissions, description, auths, this.assetChanged())
        .then(() => {
    ...
    render() {
        ...
        let {errors, isValid, update, core_exchange_rate, flagBooleans, permissionBooleans, 
            fundPoolAmount, claimFeesAmount} = this.state;
        ...
        let confirmButtons = (
            <div>
                ...
                <button className={classnames("button", {disabled: true})} onClick={this._reset.bind(this)}>
